                    ...
                    <div class="col-md-9">
                        <div class="shop-collection">
                            ...
                            <?php
                                ...
                                $consulta = "SELECT * FROM produtos WHERE categoria = '".$categoria."';";
                                ...
                                while($dado = $con->fetch_array()){
                                    ...
                                    echo '<div class="col-md-3 col-sm-6 col-xs-6" style="height: 350px;padding-botton:25px">';
                                    ...
                                    echo ' <img style="max-width: 120%;
                                    height: 200px;" class ="img-thumbnail" src="'.utf8_encode($dado["img"]).'" alt="collection-img-1" />
                                            
                                        </div><!-- .collection-img -->
                                        <div class="collection-content" style="padding-bottom:25px">
                ...
                <div class="footer-bottom">
                    <div class="copyright-txt">
                        <p>&copy; 2018 SOS Lixeiras. Todos os direitos reservados. 
                            <a href="http://ramon.salvador.br" title="Criação de Sites em Salvador"><img src="midias/man-user.png" width="20"></a></p>
                    </div><!-- .copyright-txt -->
